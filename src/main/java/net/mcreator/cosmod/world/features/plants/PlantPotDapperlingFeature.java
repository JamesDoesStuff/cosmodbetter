...
public class PlantPotDapperlingFeature extends RandomPatchFeature {
	public static PlantPotDapperlingFeature FEATURE = null;
	public static Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new PlantPotDapperlingFeature();
	...
	public PlantPotDapperlingFeature() {
