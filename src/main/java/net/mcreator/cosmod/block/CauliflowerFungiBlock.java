...
public class CauliflowerFungiBlock extends FlowerBlock {
	public CauliflowerFungiBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(CosmodModBlocks.CAULIFLOWER_FUNGI.get(), renderType -> renderType == RenderType.cutout());
	}
}
