...
public class DestroyingAngelsBlock extends FlowerBlock {
	public DestroyingAngelsBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(CosmodModBlocks.DESTROYING_ANGELS.get(), renderType -> renderType == RenderType.cutout());
	}
}
