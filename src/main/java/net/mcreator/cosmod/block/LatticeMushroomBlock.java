...
public class LatticeMushroomBlock extends FlowerBlock {
	public LatticeMushroomBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(CosmodModBlocks.LATTICE_MUSHROOM.get(), renderType -> renderType == RenderType.cutout());
	}
}
