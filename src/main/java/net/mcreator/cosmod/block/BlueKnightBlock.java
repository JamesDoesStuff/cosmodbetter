...
public class BlueKnightBlock extends FlowerBlock {
	public BlueKnightBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(CosmodModBlocks.BLUE_KNIGHT.get(), renderType -> renderType == RenderType.cutout());
	}
}
