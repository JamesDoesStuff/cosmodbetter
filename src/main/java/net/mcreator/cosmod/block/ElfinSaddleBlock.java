...
public class ElfinSaddleBlock extends FlowerBlock {
	public ElfinSaddleBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(CosmodModBlocks.ELFIN_SADDLE.get(), renderType -> renderType == RenderType.cutout());
	}
}
