...
public class GreenGlowshroomBlock extends FlowerBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(CosmodModBlocks.GREEN_GLOWSHROOM.get(), renderType -> renderType == RenderType.cutout());
	}
}
