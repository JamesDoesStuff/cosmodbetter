...
public class ScarletinaBoleteBlock extends FlowerBlock {
	public ScarletinaBoleteBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(CosmodModBlocks.SCARLETINA_BOLETE.get(), renderType -> renderType == RenderType.cutout());
	}
}
