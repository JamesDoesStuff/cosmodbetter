...
public class BluingBoleteBlock extends FlowerBlock {
	public BluingBoleteBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(CosmodModBlocks.BLUING_BOLETE.get(), renderType -> renderType == RenderType.cutout());
	}
}
