...
public class KingTrumpetBlock extends FlowerBlock {
	public KingTrumpetBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(CosmodModBlocks.KING_TRUMPET.get(), renderType -> renderType == RenderType.cutout());
	}
}
