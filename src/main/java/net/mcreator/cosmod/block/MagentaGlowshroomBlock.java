...
public class MagentaGlowshroomBlock extends FlowerBlock {
	public MagentaGlowshroomBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(CosmodModBlocks.MAGENTA_GLOWSHROOM.get(), renderType -> renderType == RenderType.cutout());
	}
}
